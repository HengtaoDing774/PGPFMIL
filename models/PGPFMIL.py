...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, coords):
        ...
        relative_position_bias = self.relative_position_bias_table[relative_position_index.view(-1)].view(-1,
                                                                                                          self.window_size,
                                                                                                          self.window_size,
                                                                                                          self.num_heads)
...
class PGPFMIL(nn.Module):
    def __init__(self, n_classes):
        ...
        self.local_layer = LocalLayer(dim=512, window_size=49)
    ...
    def forward(self,**kwargs):
        ...
        #---->Translayer x1
        # h,attn1 = self.layer1(h, return_attn=False) #[B, N, 512]
        h = self.layer1(h, return_attn=False)
